<section class="bg-[#f4f5f4]">
    <div class="mx-auto grid max-w-7xl grid-cols-1 items-center gap-10 px-6 py-16 lg:grid-cols-2 lg:gap-16">
        <div>
            <p class="mb-3 text-xs font-semibold tracking-widest text-[#1f5c47] uppercase">{{ __('Seguridad') }}</p>
            ...
            <ul class="space-y-3">
                @foreach ([
                    ...
                    <li class="flex items-center gap-3 text-sm text-neutral-700">
                        <svg class="h-5 w-5 shrink-0 text-[#1f5c47]" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
